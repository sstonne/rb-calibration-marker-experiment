...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.8948** | **1.8689** | **2.2982** | **5.1840** | **5.2408** | **5.1547** | Pending | Pending | Pending | Pending |
...
| A5 | 4.9654 | 5.0559 | 4.9399 | 5.3727 | 5.4014 | 5.3402 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio40_3 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio40_3 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio40_3 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=17; p2_fixed_cube=17; p2_gripper_cube=6; p3_board=6; p3_cube=24; p3_cube_set=14; p2_board=23; total=93.
