...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.5599** | **1.5636** | **1.7703** | **4.8751** | **4.9039** | **4.9650** | Pending | Pending | Pending | Pending |
...
| A5 | 4.7800 | 4.7344 | 4.8297 | 4.9277 | 4.9966 | 5.0394 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio40_1 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio40_1 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio40_1 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=11; p2_fixed_cube=12; p2_gripper_cube=6; p3_board=5; p3_cube=0; p3_cube_set=None; p2_board=18; total=52.
