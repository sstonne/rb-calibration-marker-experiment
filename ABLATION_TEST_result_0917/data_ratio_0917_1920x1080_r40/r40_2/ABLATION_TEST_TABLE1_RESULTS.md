...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.5742** | **1.5682** | **1.9163** | **6.0628** | **6.0068** | **6.1580** | Pending | Pending | Pending | Pending |
...
| A5 | 5.9253 | 5.8160 | 5.9617 | 6.1959 | 6.1897 | 6.3462 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio40_2 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio40_2 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio40_2 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=17; p2_fixed_cube=17; p2_gripper_cube=6; p3_board=6; p3_cube=0; p3_cube_set=None; p2_board=24; total=70.
