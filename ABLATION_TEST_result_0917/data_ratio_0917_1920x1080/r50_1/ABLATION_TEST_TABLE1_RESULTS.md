...
**계산된 방법 1개 · placement 8개 · ALL 수렴 1/1 · fold 수렴 8/8.**
...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.4767** | **1.4835** | **1.6324** | **6.2911** | **6.2998** | **6.3578** | Pending | Pending | Pending | Pending |
...
| A5 | 6.3205 | 6.3214 | 6.3542 | 6.2620 | 6.2786 | 6.3614 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio50_1 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio50_1 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio50_1 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=23; p2_fixed_cube=23; p2_gripper_cube=8; p3_board=7; p3_cube=0; p3_cube_set=None; p2_board=30; total=91.
