...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.7851** | **1.8518** | **2.2766** | **7.8832** | **8.0016** | **8.0239** | Pending | Pending | Pending | Pending |
...
| A5 | 8.1701 | 8.3112 | 8.0402 | 7.7514 | 7.8591 | 8.0166 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio30_2 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio30_2 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio30_2 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=10; p2_fixed_cube=7; p2_gripper_cube=4; p3_board=5; p3_cube=0; p3_cube_set=None; p2_board=11; total=37.
