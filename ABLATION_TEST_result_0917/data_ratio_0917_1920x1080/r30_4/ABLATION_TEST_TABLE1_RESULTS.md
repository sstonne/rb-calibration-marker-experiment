...
| A5<br>(board+cube+Unified+FtC FK fixed) | **2.3118** | **2.2364** | **3.5016** | **8.7088** | **8.8122** | **8.8487** | Pending | Pending | Pending | Pending |
...
| A5 | Pending | Pending | Pending | 8.7088 | 8.8122 | 8.8487 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio30_4 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio30_4 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio30_4 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=5; p2_fixed_cube=4; p2_gripper_cube=4; p3_board=5; p3_cube=10; p3_cube_set=14; p2_board=8; total=36.
