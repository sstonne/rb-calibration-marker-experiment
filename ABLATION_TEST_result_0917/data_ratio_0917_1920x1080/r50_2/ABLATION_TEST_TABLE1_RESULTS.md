...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.4862** | **1.4856** | **1.7578** | **5.5763** | **5.6016** | **5.5590** | Pending | Pending | Pending | Pending |
...
| A5 | 5.4700 | 5.4922 | 5.4517 | 5.6790 | 5.7072 | 5.6626 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio50_2 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio50_2 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio50_2 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=22; p2_fixed_cube=23; p2_gripper_cube=8; p3_board=7; p3_cube=31; p3_cube_set=14; p2_board=30; total=121.
