...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.5556** | **1.5610** | **1.6850** | **5.6560** | **5.6429** | **5.6731** | Pending | Pending | Pending | Pending |
...
| A5 | 5.6326 | 5.6106 | 5.6412 | 5.6785 | 5.6740 | 5.7037 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio70_3 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio70_3 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio70_3 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=30; p2_fixed_cube=28; p2_gripper_cube=10; p3_board=9; p3_cube=0; p3_cube_set=None; p2_board=39; total=116.
