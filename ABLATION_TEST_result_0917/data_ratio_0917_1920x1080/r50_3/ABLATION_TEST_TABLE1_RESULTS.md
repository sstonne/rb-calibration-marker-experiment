...
| A5<br>(board+cube+Unified+FtC FK fixed) | **1.5116** | **1.5038** | **1.7699** | **4.7277** | **4.7412** | **4.7009** | Pending | Pending | Pending | Pending |
...
| A5 | 4.4398 | 4.4698 | 4.4388 | 4.9846 | 4.9840 | 4.9358 |
...
| 입력 | 저장소 기준 경로 |
| --- | --- |
| P1 | zeus_gello_calibration/data/session1_handheld_fixed_cam_0909/capture_replayed_0917_1920x1080_ratio50_3 |
| P2 | zeus_gello_calibration/data/session2_floor_board_dual_cam_0909/capture_placed_0917_1920x1080_ratio50_3 |
| P3 | zeus_gello_calibration/data/session3_wrist_motion_gripper_cam_0909/capture_replayed_0917_1920x1080_ratio50_3 |
| cube_config | targets/gt_cube/cube_config.json |

관측 수: p1_cube=21; p2_fixed_cube=22; p2_gripper_cube=8; p3_board=7; p3_cube=31; p3_cube_set=14; p2_board=31; total=120.
